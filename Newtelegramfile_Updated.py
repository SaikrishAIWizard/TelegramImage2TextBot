...
async def handle_image(update, context):
    ...
    if update.message.photo:
        ...
        # API_KEY = "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"
        # openai.api_key = API_KEY

        # output2 = openai.ChatCompletion.create(
        #     model="gpt-3.5-turbo",
        #     messages=[{"role": "user", "content":
        #         "explain the concept the following text and elaborate it with the example if possible." + total_text}]
        # )

        # output2 = str(output2['choices'][0]['message']['content'])

        # output1 = openai.ChatCompletion.create(
        #     model="gpt-3.5-turbo",
        #     messages=[{"role": "user", "content":
        #         "convert the following text into the Bilingual telugu" + output2}]
        # )
        ...
        #await update.message.reply_text(output1['choices'][0]['message']['content'] + '/n ' +  output2)
        await update.message.reply_text('Extracted text from the image is :' + '/n ' +  total_text)
